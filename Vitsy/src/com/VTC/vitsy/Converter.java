...
public class Converter {
	public static String toVerbose(int currin, int position, String operator) throws UnrecognizedInstructionException {
		...
		case "k":
			return "goto top instruction set of second to top index class";
		case "K":
			return "execute top instruction set of superclass";
		case "g":
			return "push number of use declarations";
		case "G":
			return "push top index of classname";
		case "`":
			return "read file with name (stack)";
		case ".":
			return "write to file with name (stack)";
		case ",":
	...
	public static String toGolfed(int currin, int position, String operator) throws UnrecognizedInstructionException {
		...
		case "capture stack as object with next":
			return "o";
		case "goto top instruction set of second to top index class":
			return "k";
		case "execute top instruction set of superclass":
			return "K";
		case "push number of use declarations":
			return "g";
		case "push top index of classname":
			return "G";
		case "read file with name (stack)":
			return "`";
		case "write to file with name (stack)":
			return ".";
		case "execute stack as shell":
			return ",";
		case "eval(stack)":
			return "n";
